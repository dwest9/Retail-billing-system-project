...
class OrderDetailsFrame(Frame):
    """Frame to display the details of an order"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.order_details.column("#0", width=125)
        self.order_details.column(0, width=50)
